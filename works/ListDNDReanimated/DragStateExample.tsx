...
const DragStateExample = ({onBack}: DragStateExampleProps) => {
                            ...
                            <View style={styles.dropZoneArea}>
                                <Droppable<DraggableItemData>
                                    ...
                                    onDrop={(d:any) => {
                                        Alert.alert(
                                            "Drop!",
                                            `Item "${d.label}" dropped with state: ${dragState}`
                                        );
                                    }}
                                >
...
const getBorderColor = (state: DraggableState) => {
    switch (state) {
        case DraggableState.IDLE:
            return "#90be6d"; // Green
        case DraggableState.DRAGGING:
...
export default DragStateExample