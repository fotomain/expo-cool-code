...
function SortableExample({ onBack }: SortableExampleProps = {}) {
    ...
    useEffect(() => {
        setTimeout(() => {
            setIsLoading(false);
            //000 setIsDragHandleMode(false);
            setIsDragHandleMode(true);
        }, 500);
    }, []);
