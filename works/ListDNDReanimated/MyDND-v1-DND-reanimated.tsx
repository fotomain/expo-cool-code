...
import {Draggable, DraggableState, Droppable, DropProvider, DropProviderRef} from "@/mi/ListDNDReanimated/src";
import {runOnJS, useAnimatedReaction, useAnimatedRef, useSharedValue, withSpring} from "react-native-reanimated";
import {getItemXPosition} from "@/mi/ListDNDReanimated/src/components/sortableUtils";
...
function CollisionDetectionExample({
                                       onBack,
                                   }: CollisionDetectionExampleProps) {

    const dropProviderRef = useRef<DropProviderRef>(null);
    const ref1:any = useAnimatedRef();
    const ref2:any = useAnimatedRef();
    // const ref1:any = useSharedValue<RefObject<any>>(null);
    // const ref2:any = useSharedValue<RefObject<any>>(null);

    const showData = (d:any) =>{
        console.log("currentPosition0",d?.value)
    }
                            ...
                            <View style={[styles.draggableItemsArea, { minHeight: 240 }]}>
                                ...
                                >
                                    <View
                                        ...
                                        <Text style={styles.cardLabel}>Center111</Text>
                                ...
                                >
                                    <View
                                        ref={ref2.value}
                                        style={[styles.cardContent, { width: "100%" }]}>
                                        <Text style={styles.cardLabel}>Intersect222</Text>
...
export default CollisionDetectionExample