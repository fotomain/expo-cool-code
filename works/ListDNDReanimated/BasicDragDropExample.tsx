...
import {Draggable, Droppable, DropProvider, DropProviderRef} from "@/mi/ListDNDReanimated/src";
...
function BasicDragDropExample({ onBack }: BasicDragDropExampleProps) {
...
export default BasicDragDropExample