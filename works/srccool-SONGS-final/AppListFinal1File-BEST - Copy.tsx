...
import Animated, {
    ...
    useAnimatedReaction,
    useAnimatedRef,
    useAnimatedScrollHandler, useAnimatedStyle, useDerivedValue, useFrameCallback,
...
export const useGesture = (
    ...
    const gestureController0 = Gesture.Pan()
        .onBegin(e => {
            // .onTouchesDown(e => {
    ...
    const gestureController = useMemo(()=>gestureController0,[])
    // const gestureController =gestureController0
...
export const AUTO_SCROLL_SPEED = isAndroid ? 2 : 15;
...
const AnimatedList = (props:TListProps) => {
    ...
    let PUNKTUM_LIST_GLOBAL_HEIGHT=(height)?height:400
    if(height){
    ...
    const scrollUp = () => {
        'worklet';
        const newY =
            scrollY.value - AUTO_SCROLL_SPEED < 0
                ? 0
    ...
    const scrollDown = () => {
        ...
        const newY =
            scrollY.value + AUTO_SCROLL_SPEED > maxScroll
                ? maxScroll
                : scrollY.value + AUTO_SCROLL_SPEED;
        scrollTo(scrollviewRef, 0, newY, isIOS ? false : true);
    }
