...
export const useGesture = (
    ...
    const onGestureUpdate = (newTop: number) => {
        ...
        // optimised3: Prevent autoscroll when no more content in that direction
        const contentHeight = Object.keys(actualMomentPositions.value).length * PUNKTUM_HEIGHT;
        const canScrollUp = scrollYDerived.value > 0;
        const canScrollDown = scrollYDerived.value < contentHeight - PUNKTUM_LIST_GLOBAL_HEIGHT;
